...
urlpatterns = [
    ...
    path('components/delete/memory', views.delete_memory, name='del_memory'),
    path('components/dec/memory', views.dec_memory, name='dec_memory'),
    path('components/inc/memory', views.inc_memory, name='inc_memory'),
