...
class App(models.Model):
    ...
    min_cpu_model = models.ForeignKey(Processor, on_delete=models.PROTECT, null=True, blank=True, related_name='min_cpu') 
    min_cpu_cores = models.PositiveSmallIntegerField(null=True, blank=True)
    min_cpu_freq = models.IntegerField(null=True, blank=True)
    min_gpu_chip = models.CharField(max_length=24, blank=True, default='')
    ...
    rec_cpu_model = models.ForeignKey(Processor, on_delete=models.PROTECT, null=True, blank=True, related_name='rec_cpu')
    rec_cpu_cores = models.PositiveSmallIntegerField(null=True, blank=True)
    rec_cpu_freq = models.IntegerField(null=True, blank=True)
    rec_gpu_chip = models.CharField(max_length=24, blank=True, default='')
